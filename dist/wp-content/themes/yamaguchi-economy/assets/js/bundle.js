...
document.addEventListener('DOMContentLoaded', function () {
  // ページのHTMLが完全にロードされたら処理を実行
  var tabContainers = document.querySelectorAll('.js-tab'); // 各タブコンテナを取得

  tabContainers.forEach(function (tabContainer) {
    // 各タブコンテナごとに処理
    var tabTriggers = tabContainer.querySelectorAll('.js-tab-trigger'); // このコンテナ内のトリガーのみ取得
    var tabTargets = tabContainer.querySelectorAll('.js-tab-target'); // このコンテナ内のターゲットのみ取得

    tabTriggers.forEach(function (tabTrigger) {
      // 各トリガーに処理を実行
      tabTrigger.addEventListener('click', function (e) {
        // 各トリガーがクリックされたら
        var currentMenu = e.currentTarget; // クリックされたメニューを取得
        var currentContent = tabContainer.querySelector("#".concat(currentMenu.dataset.id)); // このコンテナ内の該当idのコンテンツを取得
...
/* harmony import */ var _tab_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_tab.js */ "./src/js/_tab.js");
/* harmony import */ var _tab_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_tab_js__WEBPACK_IMPORTED_MODULE_3__);
